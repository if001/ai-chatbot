...
import type { Namespace, Vote } from "@/lib/db/schema";
...
export function Chat({
  ...
  console.log("selected", selectedNamespaceId);
  const {
    messages,
    setMessages,
    sendMessage,
      ...
      prepareSendMessagesRequest({ messages, id, body }) {
        return {
          body: {
            ...
            namespaceId: currentNamespaceIdRef.current,
            ...body,
          },
        };
      },
        ...
        <div className="sticky bottom-0 z-1 mx-auto flex w-full max-w-4xl gap-2 border-t-0 bg-background px-2 pb-3 md:px-4 md:pb-4">
          {!isReadonly && (
            <MultimodalInput
              ...
              onNamespaceIdChange={setSelectedNamespaceId}
            />
          )}
        </div>
      </div>
